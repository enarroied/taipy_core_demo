...
def add_wine_colors(df_wine):
    ...
    Returns:
        df_wine_with_colors: DataFrame with all the input columns plus 2 nexw ones, 'red_and_rose' and 'white',
    and drops 2 columns that are not needed
    """
    ...
    # For some reason, there is some lines where the information about wine color is in the name:
    df_wine_with_colors.loc[
